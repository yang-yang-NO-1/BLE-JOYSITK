...
- 下滑扫描，找到对应 **串口打印出的mac地址**
- 连接，UUID为**12345678-1234-1234-1234-1234567890ab**项目，打开，点读取，即可获得如**00 08 01 08 00**的字符，0800代表X轴的值，0801代表Y轴的值，00的后3bit代表摇杆，BTN1，BTN2是否按下
